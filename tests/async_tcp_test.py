...
for i in range (1):
  ...
  msg  =  ("{\"jsonrpc\": \"2.0\", \"method\": \"i2c.getI2cDevices\", \"params\" : { \"device\": 0 }, \"id\" : 17}")
  sendToRSD(s, msg)

  print "request for i2c Di-Plugin"
  time.sleep(1)
  msg  =  ("{\"jsonrpc\": \"2.0\", \"method\": \"i2c.write\", \"params\" : { \"device\": 2237936547, \"slave_addr\": 56, \"data_out\" : [3, 0] }, \"id\" : 18}")
  sendToRSD(s, msg)
  
  print "request for i2c Di-Plugin"
  #time.sleep(1)
  msg  =  ("{\"jsonrpc\": \"2.0\", \"method\": \"i2c.write\", \"params\" : { \"device\": 2237936547, \"slave_addr\": 56, \"data_out\" : [1, 191] }, \"id\" : 19}")
  sendToRSD(s, msg)
  time.sleep(2)
  s.close()
